...
void TeeBeeFilter::SetCutoff(float newCutoff, bool updateCoefficients)
{
  if ( newCutoff != cutoff )
  {
...
void TeeBeeFilter::SetResonance(float newResonance, bool updateCoefficients)
{
...
float TeeBeeFilter::Process(float in)
{
  float y0;
